...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/assets/fonts/themify/themify-icons.css">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/assets/fonts/elegant-font/html-css/style.css">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/assets/vendor/noui/nouislider.min.css">
<!--===============================================================================================-->
...
<body class="animsition">
	...
	<header class="header1">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				<!-- Logo -->
				<a href="${pageContext.request.contextPath }/home.htm" class="logo">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li ${action eq 'home' ? 'class="sale-noti"' : '' }>
								<a href="${pageContext.request.contextPath }/home.htm">Inicio</a>
								
							</li>

							<li ${'hola' eq 'hola' ? 'class="sale-noti"' : '' }>
								<a href="${pageContext.request.contextPath }/categoria/productos.htm"><%= request.getContextPath() %></a>
							</li>
				...
				<div class="header-icons">
					<a href="#" class="header-wrapicon1 dis-block">
						<img src="${pageContext.request.contextPath }/assets/images/icons/icon-header-01.png" class="header-icon1" alt="ICON">
					</a>

					<span class="linedivide1"></span>

					<div class="header-wrapicon2">
						<img src="${pageContext.request.contextPath }/assets/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="${pageContext.request.contextPath }/compra/carrito.htm" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										Ver Carrito
									</a>
								</div>
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(${pageContext.request.contextPath }/assets/images/heading-pages-02.jpg);">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			<a href="#">
				<img class="h-size2" src="${pageContext.request.contextPath }/assets/images/icons/paypal.png" alt="IMG-PAYPAL">
			</a>

			<a href="#">
				<img class="h-size2" src="${pageContext.request.contextPath }/assets/images/icons/visa.png" alt="IMG-VISA">
			</a>

			<a href="#">
				<img class="h-size2" src="${pageContext.request.contextPath }/assets/images/icons/mastercard.png" alt="IMG-MASTERCARD">
			</a>

			<a href="#">
				<img class="h-size2" src="${pageContext.request.contextPath }/assets/images/icons/express.png" alt="IMG-EXPRESS">
			</a>

			<a href="#">
				<img class="h-size2" src="${pageContext.request.contextPath }/assets/images/icons/discover.png" alt="IMG-DISCOVER">
			</a>
...
<!--===============================================================================================-->
	<script type="text/javascript" src="${pageContext.request.contextPath }/assets/vendor/slick/slick.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/assets/js/slick-custom.js"></script>
<!--===============================================================================================-->
	<script type="text/javascript" src="${pageContext.request.contextPath }/assets/vendor/sweetalert/sweetalert.min.js"></script>
	<script type="text/javascript">
...
<!--===============================================================================================-->
	<script type="text/javascript" src="${pageContext.request.contextPath }/assets/vendor/noui/nouislider.min.js"></script>
	<script type="text/javascript">
		/*[ No ui ]
	    ===========================================================*/
